...
//     console.log("edit banner res is ", res);
...
//         setPreviews(updated);
//         setFormFields((f) => ({ ...f, images: updated }));
//         setDeletingIndex(null);
//       })
//       .catch(() => setDeletingIndex(null));
//   };
...
//     editData(
//       `/api/bannerList2/${context?.isOpenFullScreenPanel?.id}`,
//       formFields
//     ).then((res) => {
//       console.log(res);
...
const CatBanner_Edit_Banner = () => {
 ...
 useEffect(() => {
  ...
  fetchDataFromApi(`/api/catBanner/${id}`).then((res) => {
    console.log("edit banner res is ", res);
  ...
  const handleSubmit = (e) => {
    ...
    editData(
      `/api/catBanner/${context?.isOpenFullScreenPanel?.id}`,
      formFields
    ).then((res) => {
      console.log(res);
    ...
    <>
      ...
      flex items-center justify-center flex-col relative w-[100%] h-[150px]"
              ...
              <UploadBox
                ...
                name="images"
                setIsUploading={setIsUploading}
                url="/api/catBanner/uploadImages"
                // multiple={true}
                className="mb-3"
              />
            </div>
...
export default CatBanner_Edit_Banner;
