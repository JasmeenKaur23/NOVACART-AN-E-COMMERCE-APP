...
//         setProductsData(res?.products || res?.data?.products || []);
...
//               <div className="sideBarWrapper bg-white p-2 w-[20%]">
//                 <SideBar
...
//                       There are <span className="!text-red-800"> {productsData?.length || 0}   </span>with products
//                     </span>
//                   </div>
...
//                   className={` grid ${
//                     itemView === "grid"
//                       ? "grid-cols-4 gap-4 md:grid-cols-5"
//                       : "grid-cols-1 gap-4 md:grid-cols-1"
//                   }    `}
//                 >
//                   {itemView === "grid" ? (
//                     <>
